...
****************************************************/
$service_name='eventtpl01';
/****************************************************
세팅시 서비스할 상점아이디를 넣어줘야합니다
****************************************************/
$mysql_sale_host     = 'nextfundingtest.esmfintech.co.kr';
$mysql_sale_user     = 'nextfundingtest';
$mysql_sale_password = 'nextfundingtest5754!@#';
$mysql_sale_db       = 'nextfundingtest';
